...
import com.macro.xander.search.reposity.EsProductRepository;
...
/**
 * @author ：ZhRunXin
 * @date ：Created in 2023/2/16 17:03
 * @email ：zhrunxin33@gmail.com
 * @description：商品搜索管理实现类
 */
@Service
public class EsProductServiceImpl implements EsProductService {
    ...
    public int importAll() {
        ...
        return CollectionUtil.size(esProducts);
    }
    ...
    public EsProduct create(Long id) {
        ...
        if (esProductList.size() > 0){
            ...
            EsProduct esProductResult = esProductRepository.save(esProduct);
